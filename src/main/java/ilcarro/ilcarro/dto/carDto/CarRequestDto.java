...
public class CarRequestDto {
	...
	public CarRequestDto(String serialNumber, String make, String model, int year, String engine, String fuel,
	...
	public String toString() {
		return "CarRequestDto{" + "serialNumber='" + serialNumber + '\'' + ", make='" + make + '\'' + ", model='"
				...
				+ ", pickUpPlace=" + pickUpPlace + ", imageUrl=" + imageUrl + '}';
	}
}
